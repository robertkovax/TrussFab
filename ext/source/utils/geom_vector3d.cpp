...
const Geom::Vector3d Geom::Vector3d::ORIGIN(0.0, 0.0, 0.0);
const Geom::Vector3d Geom::Vector3d::X_AXIS(1.0, 0.0, 0.0);
const Geom::Vector3d Geom::Vector3d::Y_AXIS(0.0, 1.0, 0.0);
const Geom::Vector3d Geom::Vector3d::Z_AXIS(0.0, 0.0, 1.0);
