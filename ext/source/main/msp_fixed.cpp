...
VALUE MSP::Fixed::rbf_initialize(VALUE self, VALUE v_world, VALUE v_parent, VALUE v_child, VALUE v_matrix, VALUE v_group) {
...
void MSP::Fixed::init_ruby(VALUE mMSP) {
    VALUE cFixed = rb_define_class_under(mMSP, "Fixed", rba_cJoint);
