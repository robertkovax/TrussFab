...
var schedulingElement = d3.select('#scheduling').node();
var schedulingElementHeight = schedulingElement.getBoundingClientRect().height;
var schedulingElementWidth = schedulingElement.getBoundingClientRect().width;
