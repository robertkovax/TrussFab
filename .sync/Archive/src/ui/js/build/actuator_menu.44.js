...
function showManualActuatorSettings(pistons, breakingForce, maxSpeed) {
  ...
  var test = $('<div class="row"><div class="col-5">TExt</div><div class="col-3">Test2</div></div>');
