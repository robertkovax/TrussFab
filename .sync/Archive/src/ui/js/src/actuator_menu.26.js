function showManualActuatorSettings(pistons, breakingForce, maxSpeed) {
  ...
  const breakingForceElement = $(
    `<input class="form-control mb-2 mr-sm-2" type="number" min = "0" value="${breakingForce}" step="1"> N`
  );
  ...
  const maxSpeedElement = $(
    `<input class="form-control mb-2 mr-sm-2" type="number" min = "0" value="${maxSpeed}" step="1"> m/s`
  );
