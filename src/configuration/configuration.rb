...
module Configuration
  ...
  GENERIC_LINK_COLOR        = Sketchup::Color.new(0.0, 1.0, 0.0)
  SPRING_COLOR              = Sketchup::Color.new(0.5, 1.0, 1.0)
  DAMPER_COLOR              = Sketchup::Color.new(1.0, 1.0, 0.5)
  SPRING_DAMPER_COLOR       = Sketchup::Color.new(1.0, 0.5, 1.0)
