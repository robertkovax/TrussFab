...
require 'src/models/vibration_arrow_model.rb'
...
class ModelStorage
  ...
  def setup_models
	...
	if @models['spring_damper'].nil? || !@models['spring_damper'].valid?
      @models['spring_damper'] = SpringDamperModel.new
    end
    ...
    if @models['vibration_arrow'].nil? || !@models['vibration_arrow'].valid?
        @models['vibration_arrow'] = VibrationArrowModel.new
    end
