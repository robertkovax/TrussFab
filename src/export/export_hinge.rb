...
class ExportHinge
  def initialize(hub_id, a_other_hub_id, b_other_hub_id, a_l1, a_l2, a_l3, b_l1, b_l2, b_l3, connection_angle, a_gap, b_gap, a_with_connector, b_with_connector, presets)
    @hub_id = hub_id
