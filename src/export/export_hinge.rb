...
class ExportHinge
  ...
  def write_to_file(path)
    ...
    "draw_hinge(alpha=#{@connection_angle}, a_l1=#{@a_l1}, a_l2=#{@a_l2}, a_l3=#{@a_l3}, a_gap=#{@a_gap}, b_l1=#{@b_l1}, b_l2=#{@b_l2}, b_l3=#{@b_l3}, b_gap=#{@b_gap}, a_with_connector=#{@a_with_connector}, b_with_connector=#{@b_with_connector}, a_label=\"#{@hub_id}.#{@a_other_hub_id}\", b_label=\"#{@hub_id}.#{@b_other_hub_id}\", "].join("\n") + params + ");\n"
