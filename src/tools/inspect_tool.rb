...
class InspectTool < Tool
  ...
  def onMouseMove(_flags, x, y, view)
    ...
    data_sample_visualization = @ui.spring_pane.path_visualization.closest_visualization(position)
    ...
    @last_highlighted_visualization.un_highlight if @last_highlighted_visualization &&
        ...
        @ui.spring_pane.path_visualization.visualization_valid?(@last_highlighted_visualization)
