...
# tests if a structure can move or not
class RigidityTester
  ...
  def self.rigid?(edges)
    ...
    #   end
    # end
    # the rank of the matrix has to be higher than the number of degrees of
    # freedom (DOF) internal to the structure (which implies subtracting the
    # 6 DOF that result from moving and rotating the whole structure)
